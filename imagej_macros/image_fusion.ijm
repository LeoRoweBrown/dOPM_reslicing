...
#@ String (label="Save per...", value="[Each timepoint & channel]", choices={"[Each timepoint & channel]", "[Each view]"}) produce
...
/*  Removed this after view handling was done in the script
